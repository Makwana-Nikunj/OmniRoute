...
export OMNIROUTE_DISABLE_LOCAL_HEALTHCHECK="${OMNIROUTE_DISABLE_LOCAL_HEALTHCHECK:-true}"
export OMNIROUTE_DISABLE_TOKEN_HEALTHCHECK="${OMNIROUTE_DISABLE_TOKEN_HEALTHCHECK:-true}"
