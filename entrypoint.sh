...
export OMNIROUTE_DISABLE_BACKGROUND_SERVICES="${OMNIROUTE_DISABLE_BACKGROUND_SERVICES:-1}"
export OMNIROUTE_DISABLE_CREDENTIAL_HEALTH_CHECK="${OMNIROUTE_DISABLE_CREDENTIAL_HEALTH_CHECK:-1}"
export OMNIROUTE_DISABLE_LOCAL_HEALTHCHECK="${OMNIROUTE_DISABLE_LOCAL_HEALTHCHECK:-1}"
export OMNIROUTE_DISABLE_TOKEN_HEALTHCHECK="${OMNIROUTE_DISABLE_TOKEN_HEALTHCHECK:-1}"
export OMNIROUTE_DISABLE_CONNECTION_RECOVERY="${OMNIROUTE_DISABLE_CONNECTION_RECOVERY:-1}"
export OMNIROUTE_A2A_MEMORY_HITS="${OMNIROUTE_A2A_MEMORY_HITS:-0}"
